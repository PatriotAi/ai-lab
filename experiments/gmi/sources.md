...
- **Обмеження середовища:** **WebFetch блокований (HTTP 403)** — прямий fetch первинних PDF
  недоступний. Обхід (`source-research-harvest` info-max): крос-валідація через кілька незалежних
  **WebSearch** (винесено в субагента заради економії контексту). **T6 закрито 2026-07-18**
...
- **[E] ✅ Мозок ≈1.26× межі Ландауера (для обчислювальної частки):** бюджет мозку ~15–20 Вт
