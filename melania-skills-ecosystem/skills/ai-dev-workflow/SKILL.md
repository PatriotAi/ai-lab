...
## Зміни
- **v1.3.0** (2026-07-19) — Self-Dev Wave 2 (аудит 2026-07-18): синхрон H1-банера з frontmatter (був v1.0 при version 1.2.1) [#36]; DO NOT-межа з `experiment` — ведення/закриття експерименту за методологією лабораторії поза скоупом [#39]. Документація/тригери; тіло методології незмінне.
