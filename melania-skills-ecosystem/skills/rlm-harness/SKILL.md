...
**Стандарт диригента (ВІЧНИЙ):** `references/conductor-standard.md` — 8 дисциплін роботи найкращої моделі-оркестратора + закон не-старіння; ОБОВ'ЯЗКОВИЙ для диригента І передається кожному суб-агенту при делегуванні.
