...
## Зміни
- **v0.4.1** (2026-07-19) — Хвиля 1 Self-Dev (аудит 2026-07-18, №1): де-хардкод мертвого посилання `product-self-knowledge` (скіл не існує в екосистемі) → «офіційні docs провайдерів / web-перевірка» у SKILL.md і `references/model-fit-policy.md`. Політика «не пінь версію» незмінна.
