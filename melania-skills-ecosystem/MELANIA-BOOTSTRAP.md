...
<!-- Стан зафіксовано: 2026-07-25 · пакет melania-skills-ecosystem · governance melania v2.20.0 -->
...
1. **НЕ повторюй інсталяцію та верифікацію.** Пакет уже повністю перевірено 2026-07-25:
   ...
   (без мережевих/виконуваних викликів), `LICENSE.txt` (Apache-2.0) на місці, 133 eval-кейсів.
...
| melania-skill-master-administrator | 2.20.0 | GOVERNANCE: оновити/затвердити/упакувати скіл, версії, guard (self-bound), CHANGELOG, self-dev, pattern lifecycle |
...
- 28 скілів · 133 eval-кейсів · збірка 2026-07-25 · MANIFEST верифіковано 2026-07-25 · ліцензія Apache-2.0.
