...
<!-- Стан зафіксовано: 2026-07-21 · пакет melania-skills-ecosystem · governance melania v2.17.0 -->

## Для AI: що зробити після отримання цього файлу (і ЧОГО НЕ робити)

1. **НЕ повторюй інсталяцію та верифікацію.** Пакет уже повністю перевірено 2026-07-21:
...
## Маршрутна таблиця — 28 скілів (версії актуальні на 2026-07-21)

| Скіл | v | Активувати коли |
|---|---|---|
| semantic-router | 1.14.1 | ВХІДНА ТОЧКА: складний/неоднозначний запит, вибір скіла, мульти-скіл координація; тригери — за ЗНАЧЕННЯМ наміру, не дослівно |
...
- 28 скілів · 133 eval-кейсів · збірка 2026-07-21 · MANIFEST верифіковано 2026-07-21 · ліцензія Apache-2.0.
