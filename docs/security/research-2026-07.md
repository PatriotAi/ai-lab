...
Перевірено на диску (2026-07-27): усі 18 викликів `uses:` у чотирьох воркфлоу
...
1. Чи справді `dependency-review-action` мовчки падає на цьому репозиторії —
   перевіряється лише прогоном у GitHub (§3.2).
2. Точні безкоштовні ліміти хвилин GitHub Actions для приватних репозиторіїв —
   ...
   Free) лишаються [C].
3. Чи вплинув supply-chain-інцидент Trivy (**GHSA-69fq-xp46-6x23**, 21.03.2026)
   на версію `v0.36.0`, яку ми використовуємо — сам advisory не прочитано.
